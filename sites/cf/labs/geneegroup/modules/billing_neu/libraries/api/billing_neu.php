...
class API_Billing_Neu extends API_Common
{
    ...
    public function edit_charge($params = [], $status)
    {
        ...
        foreach ($params as $v) {
            ...
            switch ($status) {
                case 0:
                    $charge->bl_status = Billing_Neu::STATUS_DRAFT;
                    break;
                case 1:
                    $charge->bl_status = Billing_Neu::STATUS_PENDDING;
                    break;
                case 2:
                    $charge->bl_status = Billing_Neu::STATUS_RECORD;
                    break;
            }
            $charge->save();
        }
