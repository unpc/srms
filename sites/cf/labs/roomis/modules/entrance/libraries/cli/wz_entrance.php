...
class Wz_Entrance {
    static function get_all_door(){
        Upgrader::echo_fail('=========================');
		Upgrader::echo_fail('开始同步正元智慧门禁');
        Upgrader::echo_fail('=========================');
        
        $soap = QSOAP::of('door');

        $data = [
            'ApplicationID' => 'P000000000000053',
            'RequestIdentifier' => $RequestIdentifier,
        ];

        try {
            $ret = $soap->GetSmsDeliveryStatus($data);
    ...
    static function reverse_card_no(){
