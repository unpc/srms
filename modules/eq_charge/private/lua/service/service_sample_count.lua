...
fee = round(per_project_amount * service_apply_record.samples, 2)

--description模板
description = '<p>按样品数计费,项目【%project_name】费用%price/个,此次共计检测样品%samples个,共计%currency%fee</p>'

--设定replace array
params = {
    ['%project_name'] = '<span>' .. service_apply_record.project_name .. '</span>',
    ['%price'] = '<span>' .. price .. '</span>',
    ['%samples'] = '<span>' .. service_apply_record.samples .. '</span>',
