...
fee = round(sample_count * unit_price + minimum_fee, 2)
price = currency .. unit_price .. '/个'

description = '<p>测样%sample_count个, 单价 %currency%unit_price/个, 开机费 %currency%minimum_fee, 共计 %currency%fee</p>'
params = {
    ['%sample_count'] = '<span>'..sample_count..'</span>',
