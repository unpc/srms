...
class Authorization_Server_test extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->client->shouldReceive('getClient')->andReturn([
            'client_id' =>  1234,
            'client_secret' =>  5678,
            'redirect_uri'  =>  'http://foo/redirect',
            'name'  =>  'Example Client'
    ...
    public function test_checkAuthoriseParams_passedInput()
    {
        ...
        $this->scope->shouldReceive('getScope')->andReturn([
            'id'    =>  1,
            'scope' =>  'foo',
            'name'  =>  'Foo Name',
    ...
    public function test_issueAccessToken_badGrantType()
    {
        ...
        $v = $a->issueAccessToken(['grant_type' => 'foo']);
    }
    ...
    public function test_issueAccessToken()
    {
        ...
        $request = new OAuth2\Util\Request([], $_POST);
        $a->setRequest($request);
