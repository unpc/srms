...
class Patent_Model extends Presentable_Model
{

    protected $object_page = [
        'view' => '!achievements/patents/patent/index.%id',
        'edit' => '!achievements/patents/patent/edit.%id[.%arguments]',
        'delete' => '!achievements/patents/patent/delete.%id',
        'add' => '!achievements/patents/patent/add[.%arguments]',
    ];
