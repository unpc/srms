 ...
 * @usage SITE_ID=cf LAB_ID=ut Q_ROOT_PATH=~/lims2/ php test.php ../tests/50-eq_charge/times
 */
if (!Module::is_installed('eq_charge')) return true;
require_once ('charge_test.php');
class times_charge_test_1 extends charge_test
{
