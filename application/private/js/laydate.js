...
!function () {
    ...
    var e = window.layui && layui.define,
                ...
                if (n.path) {
                    ...
                    "function" == typeof a && !function c() {
                        return++ d > 80
                            ...
                            : void(
                                1989 === parseInt(t.getStyle(document.getElementById(l), "width"))
                                    ? a()
                                    : setTimeout(c, 100)
                            )
                    }()
        ...
        n = {
            v: "5.0.9",
            config: {},
            index: window.laydate && window.laydate.v
                ? 1e5
                : 0,
            path: t.getPath,
            set: function (e) {
    ...
    C.prototype.find = function (e) {
        ...
        return this.each(function (r, o) {
            for (
                var s = i
                    ? [e]
                    : o.querySelectorAll(e || null); n < s.length; n++
            ) 
                a.push(s[n]);
            t.shift()
        }),
    ...
    T.prototype.init = function () {
        ...
        t.elem[0] && (
            ...
            e.format = t.format.match(new RegExp(
                n + "|.",
                "g"
            )) || [],
            e.EXP_IF = "",
            ...
            w.each(e.format, function (t, a) {
                var i = new RegExp(n).test(a)
                    ? "\\d{" + function () {
                        return new RegExp(n).test(e.format[
                            0 === t
                                ? t + 1
                                : t - 1
                        ] || "")
    ...
    T.prototype.calendar = function (e) {
        ...
        if (
            ...
            w(f[0]).attr("lay-ym", l.year + "-" + (
                l.month + 1
            )),
            w(f[1]).attr("lay-ym", l.year + "-" + (
                l.month + 1
            )),
            "cn" === s.lang
                ? (
                    w(f[0]).attr("lay-type", "year").html(l.year + "年"),
                    w(f[1]).attr("lay-type", "month").html(
                        l.month + 1 + "月"
                    )
                )
                : (
                    ...
                    if (!w(this).hasClass(s)) {
                        ...
                        "year" === a.type || "month" === a.type
                            ? (
                                ...
                                w(this).addClass(o),
                                "month" === a.type && "year" === e && (n.listYM[t][0] = r, l && (
                                    n[
                                        ["startDate", "endDate"][t]
                                    ].year = r
                                ), n.list("month", t))
    ...
    T.prototype.events = function () {
        ...
        t.elem[0] && !t
            ...
            .eventHandler && (
                ...
                n.target !== t.elem[0] && n.target !== t.eventElem[0] && n.target !== w(
                    t.closeStop
                )[0] && e.remove()
    ...
    e
        ? (n.ready(), layui.define(function (e) {
